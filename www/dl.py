...
def download_the_av(url):
    ...
    a=list(filter(lambda x:x in "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ _-",title))
    ...
    final_path = big_path + str(title) + ".mp4"
    save_file(the_url,final_path)
